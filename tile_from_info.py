...
Training dataset generation - Generate crappified training pairs.
...
Parameters:
-------
- out: str, path, relative path where the dataset to be generated will be saved.
- info: str, path, relative path to the 'guidemap' .csv file generated by
        'gen_sample_info.py'.
...
- training image pairs/tiles for training will be saved on disk.
